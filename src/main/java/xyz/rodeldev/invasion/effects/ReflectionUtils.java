package xyz.rodeldev.invasion.effects;
...
public final class ReflectionUtils {
	...
	public enum PackageType {
		...
		public static String getVersionNumber(){
			return Bukkit.getServer().getClass().getPackage().getName().substring(27, 28).equals("_") ? Bukkit.getServer().getClass().getPackage().getName().substring(26, 27) : Bukkit.getServer().getClass().getPackage().getName().substring(26, 28);
		}
	}
