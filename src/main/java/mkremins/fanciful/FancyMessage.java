package main.java.mkremins.fanciful;

import static main.java.mkremins.fanciful.TextualComponent.rawText;
...
import main.java.net.amoebaman.util.ArrayWrapper;
import main.java.net.amoebaman.util.Reflection;
	...
	*/
	...
	private Object createChatPacket(String json) throws IllegalArgumentException, IllegalAccessException, InstantiationException, InvocationTargetException, NoSuchMethodException, ClassNotFoundException {
		if(nmsChatSerializerGsonInstance == null){
			...
			int v = Integer.parseInt(version.replaceAll("[^0-9.]", "").replace(".", ""));
