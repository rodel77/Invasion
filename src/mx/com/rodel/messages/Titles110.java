 ...
 */
public class Titles110 extends AbstractTitle{
	/* Title packet */
	 ...
	 *            Subtitle text
	 */
	public Titles110(String title, String subtitle) {
		this.title = title;
	 ...
	 *            Title
	 */
	public Titles110(Titles110 title) {
		// Copy title
	 ...
	 *            Fade out time
	 */
	public Titles110(String title, String subtitle, int fadeInTime, int stayTime,
			int fadeOutTime) {
		this.title = title;
		this.subtitle = subtitle;
	...
	public void updateTimes(Player player) {
		if (Titles110.packetTitle != null) {
			try {
				Object handle = getHandle(player);
				Object connection = getField(handle.getClass(),
						"playerConnection").get(handle);
				Object[] actions = Titles110.packetActions.getEnumConstants();
				Method sendPacket = getMethod(connection.getClass(),
						"sendPacket");
				Object packet = Titles110.packetTitle.getConstructor(
						new Class[] { Titles110.packetActions, chatBaseComponent,
			...
			try {
				...
				Object serialized = nmsChatSerializer.getConstructor(
						...
						.newInstance(
								ChatColor.translateAlternateColorCodes('&',
										this.title));
				Object packet = Titles110.packetTitle
						.getConstructor(
								new Class[] { Titles110.packetActions,
