 ...
 * @version 1.1.0
 */
public class Titles111 extends AbstractTitle{
    /* Title packet */
     ...
     */
    public Titles111(String title, String subtitle) {
        this.title = title;
     ...
     * @param title Title
     */
    public Titles111(Titles111 title) {
        // Copy title
     ...
     */
    public Titles111(String title, String subtitle, int fadeInTime, int stayTime,
                 int fadeOutTime) {
        this.title = title;
        this.subtitle = subtitle;
    ...
    public void updateTimes(Player player) {
        if (Titles111.packetTitle != null) {
            try {
                Object handle = getHandle(player);
                Object connection = playerConnection.get(handle);
                Object[] actions = Titles111.packetActions.getEnumConstants();
                Object packet = Titles111.packetTitle.getConstructor(
                        new Class[]{Titles111.packetActions, chatBaseComponent,
            ...
            try {
                ...
                Object serialized = nmsChatSerializer.getConstructor(
                        ...
                        .newInstance(titleColor +
                                ChatColor.translateAlternateColorCodes('&',
                                        this.title));
                Object packet = Titles111.packetTitle
                        .getConstructor(
                                new Class[]{Titles111.packetActions,
